...
export const file_silvana_ledger_v1_dvp: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 *
 * @generated from message silvana.ledger.v1.CancelDvpProposalParams
 */
export type CancelDvpProposalParams = Message<"silvana.ledger.v1.CancelDvpProposalParams"> & {
  /**
   * @generated from field: string dvp_proposal_cid = 1;
   */
  dvpProposalCid: string;
};

/**
 * Describes the message silvana.ledger.v1.CancelDvpProposalParams.
 * Use `create(CancelDvpProposalParamsSchema)` to create a new message.
 */
export const CancelDvpProposalParamsSchema: GenMessage<CancelDvpProposalParams> = /*@__PURE__*/
  messageDesc(file_silvana_ledger_v1_dvp, 7);
 ...
 *
 * @generated from message silvana.ledger.v1.RejectDvpProposalParams
 */
export type RejectDvpProposalParams = Message<"silvana.ledger.v1.RejectDvpProposalParams"> & {
  /**
   * @generated from field: string dvp_proposal_cid = 1;
   */
  dvpProposalCid: string;
...
/**
 * Describes the message silvana.ledger.v1.RejectDvpProposalParams.
 * Use `create(RejectDvpProposalParamsSchema)` to create a new message.
 */
export const RejectDvpProposalParamsSchema: GenMessage<RejectDvpProposalParams> = /*@__PURE__*/
  messageDesc(file_silvana_ledger_v1_dvp, 8);
