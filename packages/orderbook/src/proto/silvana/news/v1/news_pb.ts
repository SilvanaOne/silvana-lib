...
// @generated from file silvana/news/v1/news.proto (package silvana.news.v1, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file silvana/news/v1/news.proto.
 */
export const file_silvana_news_v1_news: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp]);
...
export const SourceSchema: GenMessage<Source> = /*@__PURE__*/
  messageDesc(file_silvana_news_v1_news, 0);
...
export const NewsArticleSchema: GenMessage<NewsArticle> = /*@__PURE__*/
  messageDesc(file_silvana_news_v1_news, 1);
...
export const GetNewsRequestSchema: GenMessage<GetNewsRequest> = /*@__PURE__*/
  messageDesc(file_silvana_news_v1_news, 2);
...
export type GetNewsResponse = Message<"silvana.news.v1.GetNewsResponse"> & {
   ...
   */
  cacheExpiresAt?: Timestamp | undefined;
};
...
export const GetNewsResponseSchema: GenMessage<GetNewsResponse> = /*@__PURE__*/
  messageDesc(file_silvana_news_v1_news, 3);
...
export const TokenNewsSchema: GenMessage<TokenNews> = /*@__PURE__*/
  messageDesc(file_silvana_news_v1_news, 4);
...
export const StreamNewsRequestSchema: GenMessage<StreamNewsRequest> = /*@__PURE__*/
  messageDesc(file_silvana_news_v1_news, 5);
...
export const NewsService: GenService<{
  ...
  serviceDesc(file_silvana_news_v1_news, 0);
