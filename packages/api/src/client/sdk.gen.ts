 ...
 *
 */
export const launchNftCollection = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<LaunchNftCollectionData, ThrowOnError>) => {
    return (options?.client ?? client).post<LaunchNftCollectionResponse, LaunchNftCollectionError, ThrowOnError>({
        ...options,
        url: '/nft/launch'
    });
};
 ...
 *
 */
export const mintNft = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<MintNftData, ThrowOnError>) => {
    return (options?.client ?? client).post<MintNftResponse, MintNftError, ThrowOnError>({
        ...options,
        url: '/nft/mint'
    });
};
