...
export const transferNft = <ThrowOnError extends boolean = false>(options: Options<TransferNftData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TransferNftResponse, TransferNftError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
...
export const cmsStoreNft = <ThrowOnError extends boolean = false>(options: Options<CmsStoreNftData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CmsStoreNftResponse, CmsStoreNftError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
...
export const cmsReadNft = <ThrowOnError extends boolean = false>(options: Options<CmsReadNftData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CmsReadNftResponse, CmsReadNftError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
...
export const cmsReserveNft = <ThrowOnError extends boolean = false>(options: Options<CmsReserveNftData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CmsReserveNftResponse, CmsReserveNftError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
...
export const approveNft = <ThrowOnError extends boolean = false>(options: Options<ApproveNftData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApproveNftResponse, ApproveNftError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
...
export const sellNft = <ThrowOnError extends boolean = false>(options: Options<SellNftData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SellNftResponse, SellNftError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
...
export const buyNft = <ThrowOnError extends boolean = false>(options: Options<BuyNftData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BuyNftResponse, BuyNftError, ThrowOnError>({
        security: [
            {
                name: 'x-api-key',
                type: 'apiKey'
